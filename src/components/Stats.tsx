...
const stats = [
  {
    number: "450",
    symbol: "+",
    label: "Organisations worldwide trust Ardira apps",
    icon: <GlobeIcon />,
    c: "blue",
  },
  {
    number: "5.0",
    symbol: "",
    label: "Rating on Salesforce AppExchange",
    icon: <StarIcon />,
    c: "green",
  },
  {
    number: "0",
    symbol: "",
    label: "Integrations required to get started",
    icon: <PlugIcon />,
    c: "yellow",
  },
  {
          ...
          <div
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLElement).style.borderColor =
                iconColors[s.c].color;
              (e.currentTarget as HTMLElement).style.boxShadow =
                `0 8px 24px ${iconColors[s.c].color}20`;
            ...
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLElement).style.borderColor =
                iconColors[s.c].bg;
              (e.currentTarget as HTMLElement).style.boxShadow =
                `0 4px 12px ${iconColors[s.c].color}12`;
              (e.currentTarget as HTMLElement).style.transform =
                "translateY(0)";
            }}
          >
